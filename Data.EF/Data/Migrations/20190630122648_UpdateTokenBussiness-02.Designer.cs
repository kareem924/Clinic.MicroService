...
namespace Auth.Infrastructure.Data.Migrations
{
    ...
    [Migration("20190630122648_UpdateTokenBussiness-02")]
    partial class UpdateTokenBussiness02
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Auth.Core.Entities.UserRole", b =>
                {
                    b.Property<Guid>("UserId");
            ...
            modelBuilder.Entity("Auth.Core.Entities.UserRole", b =>
                {
                    b.HasOne("Auth.Core.Entities.Role")
                        .WithMany()
                    ...
                    b.HasOne("Auth.Core.Entities.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
